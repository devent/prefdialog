 ...
 * the License.
 */
package com.anrisoftware.prefdialog.miscswing.joefficespreadsheet.table;
...
public class SheetTable extends JTable {
	...
	private final Map<Integer, Set<Integer>> selectedCells;
	...
	public SheetTable(TableModel model) {
		super(model);
		this.selectedCells = new HashMap<Integer, Set<Integer>>();
	}
