...
public class FileChooserField extends AbstractTitleField<JComboBox, Container> {
	...
	@Inject
	FileChooserField(FileChooserFieldLogger logger, @Assisted Container container,
