 ...
 * @since 2.2
 */
class LazyCreateFactory extends LazyInitializer<FileChooserFieldFactory> {
	 ...
	 */
	public FileChooserField lazyCreateField(Object bean, Field field,
			Container container) {
		try {
	...
	@Override
	protected FileChooserFieldFactory initialize() throws ConcurrentException {
		Injector injector = parentInjector
				.createChildInjector(new FileChooserModule());
		return injector.getInstance(FileChooserFieldFactory.class);
	}
