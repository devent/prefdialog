...
/**
 * Returns the combo box field for the specified field of the preferences bean
 * object.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 2.2
 */
public class FileChooserFieldPlugin implements FieldPlugin {

	private static final Class<? extends Annotation> FIELD_ANNOTATION = ComboBox.class;

	private final LazyCreateFactory lazyCreateFactory;

	public FileChooserFieldPlugin() {
	...
	@Override
	public FileChooserField getField(Object injector, Component component,
