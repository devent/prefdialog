...
/**
 * Makes the table field available.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 3.0
 */
@ProviderFor(FieldService.class)
public class TableFieldService implements FieldService {

	/**
	 * The field information.
	 */
    public static final FieldInfo INFO = new FieldInfo(Table.class);
	...
	private Injector createInjector(Injector parent) {
		return parent.createChildInjector(new TableFieldModule());
	}
}
