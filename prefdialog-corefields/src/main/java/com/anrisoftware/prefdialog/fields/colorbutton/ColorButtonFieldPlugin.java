...
/**
 * Returns the color button field for the specified field of the preferences
 * bean object.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 2.2
 */
public class ColorButtonFieldPlugin implements FieldPlugin {

	private static final Class<? extends Annotation> FIELD_ANNOTATION = ColorButton.class;

	private final LazyCreateFactory lazyCreateFactory;

	public ColorButtonFieldPlugin() {
	...
	@Override
	public ColorButtonField getField(Object injector, Component component,
