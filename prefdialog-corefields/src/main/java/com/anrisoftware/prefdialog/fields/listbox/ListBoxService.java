...
/**
 * Makes the list box field available.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 3.0
 */
@ProviderFor(FieldService.class)
public class ListBoxService implements FieldService {

	/**
	 * The field information.
	 */
	public static final FieldInfo INFO = new FieldInfo(ListBox.class);
	...
	private Injector createInjector(Injector parent) {
		return parent.createChildInjector(new ListBoxModule());
	}
}
