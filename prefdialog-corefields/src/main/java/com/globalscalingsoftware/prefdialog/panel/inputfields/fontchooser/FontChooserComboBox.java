...
class FontChooserComboBox extends JComboBox implements ItemListener {
	...
	private final LinkedList<String> recentFontNames;
	...
	class FontChooserComboBoxRenderer implements ListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value,
			...
			item.setBackground(s ? list.getSelectionBackground() : list
					.getBackground());
			item.setForeground(s ? list.getSelectionForeground() : list
					.getForeground());
			return item;
		}
	}
