...
import static com.anrisoftware.prefdialog.spreadsheetimportdialog.previewpanel.SpreadsheetPreviewPanelLogger._.error_read;
import static com.anrisoftware.prefdialog.spreadsheetimportdialog.previewpanel.SpreadsheetPreviewPanelLogger._.error_read_message;
...
/**
 * Logging messages for {@link SpreadsheetPreviewPanel}.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 3.5
 */
@Singleton
class SpreadsheetPreviewPanelLogger extends AbstractLogger {
    ...
    /**
     * Creates a logger for {@link SpreadsheetPreviewPanel}.
     */
    public SpreadsheetPreviewPanelLogger() {
        super(SpreadsheetPreviewPanel.class);
    }

    void errorRead(SpreadsheetPreviewPanel panel, SpreadsheetImportException e) {
        logException(new PropertyVetoException(error_read.toString(), null),
