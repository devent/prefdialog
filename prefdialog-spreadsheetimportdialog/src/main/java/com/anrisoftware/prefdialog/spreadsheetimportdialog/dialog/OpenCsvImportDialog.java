...
public class OpenCsvImportDialog {
    ...
    private static SpreadsheetPanelPropertiesFactory propertiesFactory;

    private static SpreadsheetPanelProperties bean;
    ...
    private static SpreadsheetImportDialog dialog;
    ...
    public static void main(String[] args) {
        ...
        injector = SpreadsheetImportDialogModule.getInjector();
    ...
    @Inject
    private SpreadsheetImportDialogFactory csvImportDialogFactory;
     ...
     */
    public SpreadsheetImportDialog createDialog() {
        JDialog jdialog = new JDialog(frame, true);
        SpreadsheetImportDialogFactory factory = csvImportDialogFactory;
        SpreadsheetImportDialog dialog = factory.create(savedProperties);
     ...
     * Opens the CSV import dialog.
     */
    public void openDialog(SpreadsheetImportDialog dialog) {
     ...
     */
    public CsvImporter createValue(SpreadsheetImportDialog dialog) throws Exception {
