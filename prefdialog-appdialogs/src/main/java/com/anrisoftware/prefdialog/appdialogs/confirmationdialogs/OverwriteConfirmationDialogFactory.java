...
/**
 * Factory to create the resource overwrite confirmation dialog.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 3.2
 */
public interface OverwriteConfirmationDialogFactory {

    /**
     * Creates the resource overwrite confirmation dialog.
     * <p>
     * <h2>AWT Thread</h2>
     * Should be called in the AWT event dispatch thread.
     * </p>
     *
     * @return the {@link OverwriteConfirmationDialog}.
     */
    @OnAwt
    OverwriteConfirmationDialog create();
}
