...
/**
 * Factory to create the resource unsaved confirmation dialog.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 3.2
 */
public interface UnsavedConfirmationDialogFactory {

    /**
     * Creates the resource unsaved confirmation dialog.
     * <p>
     * <h2>AWT Thread</h2>
     * Should be called in the AWT event dispatch thread.
     * </p>
     *
     * @return the {@link UnsavedConfirmationDialog}.
     */
    @OnAwt
    UnsavedConfirmationDialog create();
}
