...
public class OkCancelConfirmationDialog extends ConfirmationDialog {
    ...
    /**
     * Returns if the user closed the dialog by the O.k. action.
     *
     * @return {@code true} if the user closed the dialog by the O.k. action.
     */
    public boolean isOk() {
