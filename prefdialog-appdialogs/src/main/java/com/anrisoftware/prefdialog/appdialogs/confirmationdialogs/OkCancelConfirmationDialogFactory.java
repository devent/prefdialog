...
/**
 * Factory to create the Ok/Cancel confirmation dialog.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 3.2
 */
public interface OkCancelConfirmationDialogFactory {

    /**
     * Creates the Ok/Cancel confirmation dialog.
     * <p>
     * <h2>AWT Thread</h2>
     * Should be called in the AWT event dispatch thread.
     * </p>
     *
     * @return the {@link OkCancelConfirmationDialog}.
     */
    @OnAwt
    OkCancelConfirmationDialog create();
}
