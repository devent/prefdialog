...
/**
 * Installs the dialog header.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 * @see DialogHeaderFactory
 */
public class DialogHeaderModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new FactoryModuleBuilder().implement(DialogHeader.class,
                DialogHeader.class).build(DialogHeaderFactory.class));
    }
