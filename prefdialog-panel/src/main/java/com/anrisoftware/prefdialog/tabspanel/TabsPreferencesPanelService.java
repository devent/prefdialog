...
/**
 * Makes the tabs preferences panel available as a service.
 * 
 * @see TabsPreferencesPanel
...
public class TabsPreferencesPanelService implements FieldService {

	/**
	 * The field information.
	 */
	public static final FieldInfo INFO = new FieldInfo(
			TabsPreferencesPanel.class);
	...
	private Injector createInjector(Injector parent) {
		return parent.createChildInjector(new TabsPreferencesPanelModule());
	}
}
