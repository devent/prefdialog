 ...
 * @since 3.0
 */
class VerticalPreferencesPanelModule extends AbstractModule {

	@Override
	protected void configure() {
		install(new FactoryModuleBuilder().implement(
				new TypeLiteral<FieldComponent<JPanel>>() {
				}, VerticalPreferencesPanelField.class).build(
				VerticalPreferencesPanelFieldFactory.class));
		bind(FieldFactory.class).to(VerticalPreferencesPanelFieldFactory.class);
	}
